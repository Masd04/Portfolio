const styles = {
  ...
  heading1: "font-poppins font-semibold text-[35px] xr:text-[40px] xs:text-[53px] text-white xs:leading-[76.8px] leading-[66.8px] w-[95%] sm:w-full text-center select-none",
